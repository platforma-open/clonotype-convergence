...
export type ClonotypeConvergenceBlockContract = BlockContract;
export type ClonotypeConvergenceBlockOutputs  = BlockOutputs;
export type ClonotypeConvergenceBlockData     = BlockData;
export const ClonotypeConvergenceBlockPointer = BlockPointer;
